...
class MAVLink_soil_volumetric_water_content_message(MAVLink_message):
        ...
        def __init__(self, vwc):
                MAVLink_message.__init__(self, MAVLink_soil_volumetric_water_content_message.id, MAVLink_soil_volumetric_water_content_message.name)
                self._fieldnames = MAVLink_soil_volumetric_water_content_message.fieldnames
                self.vwc = vwc

        def pack(self, mav, force_mavlink1=False):
                return MAVLink_message.pack(self, mav, 149, struct.pack('<f', self.vwc), force_mavlink1=force_mavlink1)
...
class MAVLink_soil_temperature_message(MAVLink_message):
        ...
        fieldnames = ['soil_temp']
        ordered_fieldnames = [ 'soil_temp' ]
        format = '<f'
        native_format = bytearray('<f', 'ascii')
        orders = [0]
        lengths = [1]
        ...
        def __init__(self, soil_temp):
                MAVLink_message.__init__(self, MAVLink_soil_temperature_message.id, MAVLink_soil_temperature_message.name)
                self._fieldnames = MAVLink_soil_temperature_message.fieldnames
...
class MAVLink(object):
        ...
        def soil_volumetric_water_content_encode(self, vwc):
                ...
                '''
                return MAVLink_soil_volumetric_water_content_message(vwc)

        def soil_volumetric_water_content_send(self, vwc, force_mavlink1=False):
                '''
                This message is reported back from the sensor to the central node.
                It contains the VWC value as reported by the
                Vegetronix VH400 soil                         moisture
                ...
                '''
                return self.send(self.soil_volumetric_water_content_encode(vwc), force_mavlink1=force_mavlink1)

        def soil_temperature_encode(self, soil_temp):
                '''
                This message is reported back from the sensor to the central node.
                ...
                '''
                return MAVLink_soil_temperature_message(soil_temp)

        def soil_temperature_send(self, soil_temp, force_mavlink1=False):
                '''
                This message is reported back from the sensor to the central node.
                It contains the soil temperature as reported by the
                Vegetronix                         THERM200 soild
